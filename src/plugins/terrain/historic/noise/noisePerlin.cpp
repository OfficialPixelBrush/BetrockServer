    ...
    return lerp(u,
        lerp(v,
            lerp(w,
                ...
                grad(this->permutations[yIndex], x - 1.0, y, z)
            ), lerp(w,
                grad(this->permutations[permXY], x, y - 1.0, z),
                ...
                grad(this->permutations[permXY + 1], x, y - 1.0, z - 1.0),
...
double NoisePerlin::GenerateNoise(double x, double y) {
    return this->GenerateNoiseBase(x, y, 0.0);
}
        ...
        */
        ...
        for(int var30 = 0; var30 < xSize; ++var30) {
            ...
            for(var37 = 0; var37 < zSize; ++var37) {
                ...
                var70 = lerp(var35, altGrad(this->permutations[zOffset6], var31, var38), grad(this->permutations[xOffset2], var31 - 1.0, 0.0, var38));
                var73 = lerp(var35, grad(this->permutations[zOffset6 + 1], var31, 0.0, var38 - 1.0), grad(this->permutations[xOffset2 + 1], var31 - 1.0, 0.0, var38 - 1.0));
            ...
            for(int yOffset4 = 0; yOffset4 < zSize; ++yOffset4) {
                ...
                for(int var51 = 0; var51 < ySize; ++var51) {
                    ...
                    if(var51 == 0 || var55 != xOffset2) {
                        ...
                        xOffset9 = lerp(yOffset2, grad(this->permutations[var71], var38, var52, yOffset5), grad(this->permutations[var75], var38 - 1.0, var52, yOffset5));
                        var31 = lerp(yOffset2, grad(this->permutations[var72], var38, var52 - 1.0, yOffset5), grad(this->permutations[var76], var38 - 1.0, var52 - 1.0, yOffset5));
                        var33 = lerp(yOffset2, grad(this->permutations[var71 + 1], var38, var52, yOffset5 - 1.0), grad(this->permutations[var75 + 1], var38 - 1.0, var52, yOffset5 - 1.0));
                        var35 = lerp(yOffset2, grad(this->permutations[var72 + 1], var38, var52 - 1.0, yOffset5 - 1.0), grad(this->permutations[var76 + 1], var38 - 1.0, var52 - 1.0, yOffset5 - 1.0));
                    }
