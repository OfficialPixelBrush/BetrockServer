...
#define PROJECT_VERSION_FULL_STRING "0.2.8 (latest/1a78f9a)"
#define PROJECT_NAME "BetrockServer"
#define PROJECT_GIT_COMMIT "1a78f9a"
#define PROJECT_GIT_BRANCH "latest"
#define PROJECT_NAME_VERSION "BetrockServer 0.2.8"
#define PROJECT_NAME_VERSION_FULL "BetrockServer 0.2.8 (latest/1a78f9a)"
